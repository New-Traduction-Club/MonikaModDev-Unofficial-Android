...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("Can you tell me a story?"),
            pool=True,
            unlocked=True
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("The Cat and the Cock"),
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("The Shepherd Boy and the Wolf"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("The Wind and the Sun"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("Old Man's Three Wishes"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("A mother and her trees"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("The Crow and the Pitcher"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("Having A Best Friend"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("The Weaver Girl and the Cowherd"),
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False,
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Hunter"),unlocked=True),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("Kuchisake-Onna"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("Mujina"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Ubume"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Woman in Black"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("Resurrection Mary"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Resuscitated Corpse"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("Jack O' Lantern"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("Baobhan Sith"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Serial Killer"),unlocked=False),
    code="STY")
...
init 5 python:
    ...
    category=[store.mas_stories.TYPE_SCARY], prompt=__("The Revenant"),unlocked=False),
    code="STY")
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[store.mas_stories.TYPE_SCARY],
            prompt=__("The Flowered Lantern"),
            unlocked=False
        ),
        code="STY"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[store.mas_stories.TYPE_SCARY],
            prompt=__("The Flowered Lantern 2"),
            pool=True,
            unlocked=False
        ),
        code="STY"
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[store.mas_stories.TYPE_SCARY],
            prompt=__("The Flowered Lantern 3"),
            pool=True,
            unlocked=False
        ),
        code="STY"
