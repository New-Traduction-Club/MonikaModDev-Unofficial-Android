...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=True,
            prompt=__("I'll be going away for a while."),
            pool=True
        ),
        code="BYE"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=True,
            prompt=__("I'm going to take you somewhere."),
            pool=True
        ),
        code="BYE"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=True,
            prompt=__("I'm going to play another game."),
            pool=True
        ),
        code="BYE"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=True,
            prompt=__("I'm going to do some housework."),
            pool=True
        ),
        code="BYE"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=True,
            prompt=__("I'm going to restart."),
            pool=True
        ),
        code="BYE"
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("I'm going to work out."),
            unlocked=True,
            pool=True
        ),
        code="BYE"
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=__("I'm going to hang out with friends."),
            unlocked=True,
            pool=True
        ),
        code="BYE"
