...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_hungry",prompt=__("...hungry."),category=[store.mas_moods.TYPE_NEUTRAL],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,"mas_mood_sad",prompt=__("...sad."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_happy",prompt=__("...happy."),category=[store.mas_moods.TYPE_GOOD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_tired",prompt=__("...tired."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_lonely",prompt=__("...lonely."),category=[store.mas_moods.TYPE_NEUTRAL],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,"mas_mood_angry",prompt=__("...angry."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_scared",prompt=__("...anxious."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_inadequate",prompt=__("...inadequate."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_crying",prompt=__("...like crying."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_upset",prompt=__("...upset."),category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
